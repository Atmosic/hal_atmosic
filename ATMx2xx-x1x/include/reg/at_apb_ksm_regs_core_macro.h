 ...
 * @details how many consecutive scans are needed before key press or key release event?
 * @{
 */
 ...
 * @brief timing parameters definitions.
 * @{
 */
 ...
 * @brief maxtrix size definitions.
 * @{
 */
 ...
 * @details if 1, ignore this packet
 * @{
 */
 ...
 * @brief low power wake key --OBSOLETE-- definitions.
 * @{
 */
 ...
 * @brief ksi values for loopback definitions.
 * @{
 */
