...
#define RADIO_SYNTH_SYNTH_CTRL_1__READ                              0x3fffffffU
#define RADIO_SYNTH_SYNTH_CTRL_1__WRITE                             0x3fffffffU
 ...
 * @brief Synth txmod static bits, spare bits, PA and PA LDO enable controls and overrides definitions.
 * @{
 */
 ...
 * @details synth local register internal spare bits taken out as pins to synthDigital. 0->disableVcoModClk - Disables the VCO modulation clock, with which the data in the high frequency modulation path is retimed, 2:1->enable div3 900MHz PA path and control duty cycle, 00 - disabled, 01 - 33%, 10 - 50%, 11 - 66%, 5:3->number of output stages for 900MHz PA
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREEXT__SHIFT                             9
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREEXT__WIDTH                             8
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREEXT__MASK                    0x0001fe00U
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREEXT__READ(src) \
                    (((uint32_t)(src)\
                    & 0x0001fe00U) >> 9)
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREEXT__WRITE(src) \
                    (((uint32_t)(src)\
                    << 9) & 0x0001fe00U)
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREEXT__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x0001fe00U) | (((uint32_t)(src) <<\
                    9) & 0x0001fe00U)
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREEXT__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 9) & ~0x0001fe00U)))
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREEXT__RESET_VALUE             0x00000000U
/** @} */
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_2__DISABLERXLOBUF__SHIFT                      17
#define RADIO_SYNTH_SYNTH_CTRL_2__DISABLERXLOBUF__WIDTH                       1
#define RADIO_SYNTH_SYNTH_CTRL_2__DISABLERXLOBUF__MASK              0x00020000U
...
/**
 * @defgroup radio_synth_regs_core_spareInt_field spareInt_field
 * @brief macros for field spareInt
 * @details synth local register internal spare bits
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREINT__SHIFT                            27
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREINT__WIDTH                             5
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREINT__MASK                    0xf8000000U
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREINT__READ(src) \
                    (((uint32_t)(src)\
                    & 0xf8000000U) >> 27)
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREINT__WRITE(src) \
                    (((uint32_t)(src)\
                    << 27) & 0xf8000000U)
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREINT__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0xf8000000U) | (((uint32_t)(src) <<\
                    27) & 0xf8000000U)
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREINT__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 27) & ~0xf8000000U)))
#define RADIO_SYNTH_SYNTH_CTRL_2__SPAREINT__RESET_VALUE             0x00000000U
/** @} */
...
#define RADIO_SYNTH_SYNTH_CTRL_2__RESET_VALUE                       0x04900040U
...
/**
 * @defgroup radio_synth_regs_core_modVarSize_1M_field modVarSize_1M_field
 * @brief macros for field modVarSize_1M
 * @details modulation varactor size for 1Mbps rate
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_1M__SHIFT                        0
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_1M__WIDTH                        3
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_1M__MASK               0x00000007U
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_1M__READ(src) \
                    ((uint32_t)(src)\
                    & 0x00000007U)
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_1M__WRITE(src) \
                    ((uint32_t)(src)\
                    & 0x00000007U)
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_1M__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000007U) | ((uint32_t)(src) &\
                    0x00000007U)
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_1M__VERIFY(src) \
                    (!(((uint32_t)(src)\
                    & ~0x00000007U)))
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_1M__RESET_VALUE        0x00000003U
/** @} */
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARBIAS_1M__SHIFT                        3
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARBIAS_1M__WIDTH                        4
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARBIAS_1M__MASK               0x00000078U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_1M__SHIFT                     7
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_1M__WIDTH                     5
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_1M__MASK            0x00000f80U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_1M__SHIFT                       12
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_1M__WIDTH                        1
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_1M__MASK               0x00001000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_1M__SHIFT                  13
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_1M__WIDTH                   3
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_1M__MASK          0x0000e000U
...
/* macros for field modVarSize_2M */
/**
 * @defgroup radio_synth_regs_core_modVarSize_2M_field modVarSize_2M_field
 * @brief macros for field modVarSize_2M
 * @details modulation varactor size for 2Mbps rate
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_2M__SHIFT                       16
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_2M__WIDTH                        3
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_2M__MASK               0x00070000U
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_2M__READ(src) \
                    (((uint32_t)(src)\
                    & 0x00070000U) >> 16)
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_2M__WRITE(src) \
                    (((uint32_t)(src)\
                    << 16) & 0x00070000U)
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_2M__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00070000U) | (((uint32_t)(src) <<\
                    16) & 0x00070000U)
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_2M__VERIFY(src) \
                    (!((((uint32_t)(src)\
                    << 16) & ~0x00070000U)))
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARSIZE_2M__RESET_VALUE        0x00000007U
/** @} */
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARBIAS_2M__SHIFT                       19
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARBIAS_2M__WIDTH                        4
#define RADIO_SYNTH_SYNTH_CTRL_3__MODVARBIAS_2M__MASK               0x00780000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_2M__SHIFT                    23
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_2M__WIDTH                     5
#define RADIO_SYNTH_SYNTH_CTRL_3__MODBUCKETSIZE_2M__MASK            0x0f800000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_2M__SHIFT                       28
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_2M__WIDTH                        1
#define RADIO_SYNTH_SYNTH_CTRL_3__MODDELAYHF_2M__MASK               0x10000000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_2M__SHIFT                  29
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_2M__WIDTH                   3
#define RADIO_SYNTH_SYNTH_CTRL_3__MODRELPATHDELAY_2M__MASK          0xe0000000U
...
#define RADIO_SYNTH_SYNTH_CTRL_3__RESET_VALUE                       0x03c703c3U
...
#define RADIO_SYNTH_SYNTH_READOUT__FSM_STATE__WIDTH                           3
#define RADIO_SYNTH_SYNTH_READOUT__FSM_STATE__MASK                  0x00000007U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VCOCAPS__SHIFT                         4
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VCOCAPS__WIDTH                         7
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VCOCAPS__MASK                0x000007f0U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVCAPSEARCH__SHIFT                   11
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVCAPSEARCH__WIDTH                    1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVCAPSEARCH__MASK           0x00000800U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_ENSYNTHANALOG__SHIFT                  12
#define RADIO_SYNTH_SYNTH_READOUT__FSM_ENSYNTHANALOG__WIDTH                   1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_ENSYNTHANALOG__MASK          0x00001000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_PINVC__SHIFT                          13
#define RADIO_SYNTH_SYNTH_READOUT__FSM_PINVC__WIDTH                           1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_PINVC__MASK                  0x00002000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_SHORTR__SHIFT                         14
#define RADIO_SYNTH_SYNTH_READOUT__FSM_SHORTR__WIDTH                          1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_SHORTR__MASK                 0x00004000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVRST__SHIFT                         15
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVRST__WIDTH                          1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVRST__MASK                 0x00008000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVENTOGGLE__SHIFT                    16
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVENTOGGLE__WIDTH                     1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_DIVENTOGGLE__MASK            0x00010000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_PFDRST__SHIFT                         17
#define RADIO_SYNTH_SYNTH_READOUT__FSM_PFDRST__WIDTH                          1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_PFDRST__MASK                 0x00020000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_ENSD__SHIFT                           18
#define RADIO_SYNTH_SYNTH_READOUT__FSM_ENSD__WIDTH                            1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_ENSD__MASK                   0x00040000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VC2HI_SYNC__SHIFT                     19
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VC2HI_SYNC__WIDTH                      1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VC2HI_SYNC__MASK             0x00080000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VC2LO_SYNC__SHIFT                     20
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VC2LO_SYNC__WIDTH                      1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_VC2LO_SYNC__MASK             0x00100000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__FSM_NOLOCK_SYNC__SHIFT                    21
#define RADIO_SYNTH_SYNTH_READOUT__FSM_NOLOCK_SYNC__WIDTH                     1
#define RADIO_SYNTH_SYNTH_READOUT__FSM_NOLOCK_SYNC__MASK            0x00200000U
 ...
 * @{
 */
#define RADIO_SYNTH_SYNTH_READOUT__TXMODGAIN__SHIFT                          22
#define RADIO_SYNTH_SYNTH_READOUT__TXMODGAIN__WIDTH                           5
#define RADIO_SYNTH_SYNTH_READOUT__TXMODGAIN__MASK                  0x07c00000U
...
#define RADIO_SYNTH_SYNTH_READOUT__READ                             0x07fffff7U
