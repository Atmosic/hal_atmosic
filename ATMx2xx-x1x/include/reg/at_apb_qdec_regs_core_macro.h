 ...
 * @details the second phase signal if in loopback
 * @{
 */
 ...
 * @details the first phase signal if in loopback
 * @{
 */
 ...
 * @details invert both phase signals before any processing
 * @{
 */
 ...
 * @details purge the accumulator count after a read to its register
 * @{
 */
 ...
 * @details purge the error count after a read to its register
 * @{
 */
 ...
 * @details indicates if purge is in progress; purge signal needs to be synch'ed to 32kHz domain; purge is done when bit makes high to low transition; alternatively software can either wait or not issue new read for 5 LPC cycles
 * @{
 */
 ...
 * @defgroup at_apb_qdec_regs_core_accum_purge_sts_field accum_purge_sts_field
 * @brief macros for field accum_purge_sts
 * @details indicates if purge has completed
 * @{
 */
